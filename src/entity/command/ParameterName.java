 ...
 * are only a few clearly defined parameter names.
 * 
...
public enum ParameterName {
     ...
     * @throws InvalidParameterNameException if the string is rubbish
     */
    public static ParameterName parseParamName(String str) throws InvalidParameterNameException {
